...
?>
			...
			<div style="width:100%; height:300px; background:url(images/fond_ecolo.png);">	</div>
	<!-- projects -->
	<div class="gallery" id="projects">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="tittle text-center font-weight-bold text-uppercase mb-sm-5 mb-4">
				<span class="font-weight-bold text-center">E</span>Recrutement</h3>
			<div class="gallery-info">
				<div class="row">
				<div class="container">
				<img src="uploads/1532198383IMG_0044.jpg" style="float:right; width:50%; margin-left:30px;">
					<h3>Nous recrutons</h3></h3><br>
	...
	<!-- video section -->
		...
		<div class="container-fluid py-lg-5 py-md-4">
			<div class="row py-xl-3">
				...
				<div class="col-lg-3">
					<a href="#contact" class="btn scroll mt-4">En savoir Plus</a>
				</div>
			</div>
		</div>
	</div>	<!-- //video section -->
